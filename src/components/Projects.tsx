        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm">
            <h3 className="text-xl font-semibold">
              Cash Widget - Skipper Booking Engine
            </h3>
            <p className="text-gray-600 text-sm mt-1">Skipper Hospitality</p>
            <p className="text-gray-700 mt-2">
              A modern booking widget built with Svelte and TypeScript,
              featuring payment processing and real-time availability checking.
            </p>
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm">
            <h3 className="text-xl font-semibold">
              Hospitality Website Solutions
            </h3>
            <p className="text-gray-600 text-sm mt-1">Skipper Hospitality</p>
            <p className="text-gray-700 mt-2">
              Custom 11ty framework for developing high-performance hotel
              websites with island architecture.
            </p>
            <div className="mt-4 space-x-4">
              <span className="inline-block bg-gray-100 px-3 py-1 rounded text-sm">
                11ty
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm">
            ...
            <p className="text-gray-700 mt-2">
              Hotel guest amenity ordering platform with real-time order
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm">
            <h3 className="text-xl font-semibold">
              Butler Mobile & Expeditor Apps
            </h3>
            <p className="text-gray-600 text-sm mt-1">Butler Hospitality</p>
            <p className="text-gray-700 mt-2">
              Cross-platform mobile applications for order management and
              kitchen operations.
            </p>
            <div className="mt-4 space-x-4">
              <span className="inline-block bg-gray-100 px-3 py-1 rounded text-sm">
      ...
      <section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-white p-6 rounded-lg shadow-sm">
            ...
            <p className="text-gray-700 mt-2">
              A lightweight image gallery component for Svelte applications.
            </p>
            <a
              href="https://github.com/azs06/svelte-lightbox"
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm">
            ...
            <p className="text-gray-700 mt-2">
              An open-source web components library for building hospitality
              websites.
            </p>
            <a
              href="https://github.com/Skipper-Hospitality/organisms"
              className="text-blue-600 hover:text-blue-800 mt-4 inline-block"
            >
              View Project →
            </a>
